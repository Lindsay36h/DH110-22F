...
To summarize what was learned from the interview, I would say finding research articles is a time-consuming process since simple information like keywords do not illustrate an article’s usefulness to a researcher. When searching for articles, researchers rely on the article’s abstract to determine if the article will be of any use to them, and if they will further investigate the article. On a research search page, an article’s title, authors, keywords, and a portion of the abstract are all attractive features of individual articles. Moreover, if an online library or database has a large variety of research that can be accessed from it, website organization of different research topics is helpful; without it, the participant feels lost or overwhelmed by the website. I learned environmental researchers often use NOAA (National Oceanic and Atmospheric Administration) to find data online. The participant mainly uses google scholar and Humboldt State’s library website to find research articles, and while they like both websites, they acknowledge the library website could be better organized and Google Scholar can give many unhelpful results after a search.
